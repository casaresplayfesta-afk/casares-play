...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .cta{display:inline-block;margin-top:12px;padding:10px 14px;border-radius:10px;background:var(--accent);color:white;text-decoration:none;font-weight:600}
...
<body>
  <header>
    <img src="WhatsApp%20Image%202025-09-24%20at%2018.19.38.jpeg" alt="Logo CasaRes Play">
    <div class="container">
      <h1>CasaRes Play</h1>
    ...
    <section class="hero">
      ...
      <div style="width:320px">
        <div class="contact-card">
          ...
          <a class="cta" href="tel:+5521968884003">Reservar via WhatsApp</a>
        </div>
      </div>
    </section>
    ...
    <section style="margin-top:24px">
      ...
      <div class="pricing">
        <div class="pkg">
          ...
          <a class="cta" href="mailto:casaresplayfesta@gmail.com?subject=Reserva%20-%2030%20pel%C3%BAcias">Reservar</a>
        </div>
        ...
        <div class="pkg">
          ...
          <a class="cta" href="mailto:casaresplayfesta@gmail.com?subject=Reserva%20-%2050%20pel%C3%BAcias">Reservar</a>
        </div>
        ...
        <div class="pkg">
          ...
          <a class="cta" href="mailto:casaresplayfesta@gmail.com?subject=Reserva%20-%2080%20pel%C3%BAcias">Reservar</a>
        </div>
        ...
        <div class="pkg">
          ...
          <a class="cta" href="mailto:casaresplayfesta@gmail.com?subject=Reserva%20-%20Somente%20m%C3%A1quina">Reservar</a>
        </div>
      </div>
    </section>

...
<main>
  ...
  <div class="pricing">
    ...
    <!-- Pacote SOMENTE MÁQUINA -->
    <div class="pkg">
      <div class="swiper pacoteSwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide"><img src="maquina.jpg" alt="Somente máquina - imagem 1"></div>
          <div class="swiper-slide"><img src="maquina2.jpg" alt="Somente máquina - imagem 2"></div>
        </div>
        <div class="swiper-pagination"></div>
      </div>
      <div class="pkg-content">
        <h3>Somente Máquina (4h)</h3>
        <div class="price">R$ 550</div>
        <div class="etiquetas">
          <span class="etiqueta">4 horas de uso</span>
          <span class="etiqueta">Montagem inclusa</span>
        </div>
        <ul>
          <li>Uso da máquina por 4 horas</li>
          <li>Sem pelúcias inclusas</li>
          <li>Ideal para quem já possui brindes</li>
        </ul>
        <a class="cta">Indisponível no momento</a>
      </div>
    </div>
    ...
    <div class="pkg">
      <div class="swiper pacoteSwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide"><img src="personalizado.jpg" alt="Pacote personalizado"></div>
        </div>
        <div class="swiper-pagination"></div>
      </div>
      <div class="pkg-content">
        <h3>Pacote Personalizado</h3>
        <div class="price">Valor variável</div>
        <ul>
          <li>Monte seu pacote com a quantidade de pelúcias desejada</li>
          <li>Personalize conforme sua festa</li>
        </ul>
        <a class="cta">Indisponível no momento</a>
      </div>
    </div>
